...
# jar 파일명 확인 -> 파일명이 $PROC_NAME 변수와 $DAEMON 변수에 저장됨.
PROC_NAME="$(ls ../springboot )"
echo ${PROC_NAME}
readonly DAEMON="/home/infra/apps/springboot/${PROC_NAME}"
# 프로세스 아이디가 존재할 패스를 설정
readonly PID_PATH="/home/infra/apps/bin/"
